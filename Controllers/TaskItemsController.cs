...
namespace TaskDelegatingApp.Controllers
{
    public class TaskItemsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("TaskItemID,Name,Description,TimeofDay,DayAssigned,PersonId,DayId")] TaskItem taskItem)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("TaskItemID,Name,Description,TimeofDay,DayAssigned,PersonId,DayId")] TaskItem taskItem)
        {
